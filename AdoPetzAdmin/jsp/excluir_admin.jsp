...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("POST")) {
        ...
        if (email != null && !email.isEmpty()) {
            ...
            try {
                if (connection != null) {
                    // Excluir dados da tabela administrador
...
<head>
    ...
    <title>Excluir Dados do Administrador</title>
...
<body>
    <div class="container">
        <h1>Excluir Dados do Administrador</h1>
        <form action="" method="post">
            <label for="email">Digite o e-mail do administrador:</label><br>
